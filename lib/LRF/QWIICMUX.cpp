...
bool QWIICMUX::begin(uint8_t deviceAddress, i2c_t3 &wirePort)
{
  //Get user's options
  _i2cPort = &wirePort;
...
bool QWIICMUX::isConnected()
{
  ...
  Serial.println("asfdasdf");

  if (_i2cPort->endTransmission() != 0){
    Serial.println("did not ACK");
