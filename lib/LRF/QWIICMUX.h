...
{
public:
  bool begin(uint8_t deviceAddress = QWIIC_MUX_DEFAULT_ADDRESS, i2c_t3 &wirePort = Wire); //Check communication and initialize device
...
private:
  i2c_t3 *_i2cPort;                                  //This stores the user's requested i2c port
